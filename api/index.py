...
@app.route("/")
def credit():
    return "(CricHD-API) Made With ❤— By MH SPORTS"
...
    response = requests.get(f"https://lovesomecommunity.com/crichdcom.php?player=desktop&live={channel_id}", headers={"Referer": "https://stream.crichd.vip/"})
